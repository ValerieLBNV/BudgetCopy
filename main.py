...
def copy_data(version):
    #TODO: So what you need to do here is put this entire code below into a for loop (VERY similar to what we did in the archive method)
    ...
    # from keys you will get the name of the file to read from and from values you will get the names of the sheets to paste to ( I think thats what it is at least)
    # and then what is left is only to change these values in your code below to these newly gotten values. And voala, you have it nice and dynamic.
